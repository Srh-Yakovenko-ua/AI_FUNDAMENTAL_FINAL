...
UNIT_ALIASES = {
    # Форми пишемо повністю, а не огризком: find_units шукає по МЕЖАХ СЛОВА,
    # тому основа на кшталт «кубічн» не збігається ніколи, бо далі йде літера.
    "км/год": ["км/год", "км/г", "kmh", "кілометрів на годину",
               "кілометри на годину", "кілометрів за годину"],
    "м/с": ["м/с", "m/s", "метрів на секунду", "метри за секунду",
            "метрів за секунду"],
    "л": ["літрах", "літрів", "літри", "літра", "літр", "л"],
    "м³": ["кубічних метрів", "кубічних метрах", "кубічні метри", "кубічний метр",
           "кубометрів", "кубометри", "кубометр", "м³", "кубічн", "м3"],
    # Голі C і F потрібні тому, що сам інструмент у підказці друкує «C→F»:
    # без них він пропонував синтаксис, якого не розумів.
    "C": ["цельсія", "цельсій", "цельсіях", "цельсієм", "°c", "°с", "c"],
    "F": ["фаренгейтах", "фаренгейтів", "фаренгейти", "фаренгейт", "°f", "f"],
